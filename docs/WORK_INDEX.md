...
| T006 — Direct rTM NILM Prototype | 用 causal aggregate input 构建 flat TMU integer-weighted rTM NILM workflow 并验证 sample-wise fridge power feasibility | Paused; public REDD data-supply increment complete — 2026-07-29 | [Task](tasks/T006-direct-rtm-nilm-prototype.md), [D007](decisions/D007-direct-rtm-nilm-prototype-method-boundary.md), [D008](decisions/D008-public-rtm-workflow-and-integer-weighted-model.md) |
...
| R006 — Compact rTM Computation Cost Probe | 只测 frozen C8/C11 在真实 TMU CPU path 的 time、RSS、throughput 和 calculated model size | Halted — 2026-07-28；首次 C8 run 触发 stop rule，C11 未运行 | [Probe record](reviews/R006-compact-rtm-computation-cost-probe.md) |
