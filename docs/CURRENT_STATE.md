...
| R006 — Compact rTM Computation Cost Probe | Halted — 2026-07-28 | 首次 C8 staircase 出现 unexplained runtime/memory observations；因无 step checkpoint，不能确认 active step 或逐步 timing；进程已停止、无 partial result、C11 未启动 |
