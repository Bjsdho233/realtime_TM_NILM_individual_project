...
| Formal Protocol R evaluation contract is internally consistent | [R002](reviews/R002-evaluation-protocol-consistency-review.md) | Not yet | 只能说明冲突已识别 | mixed-house/held-out-house 和 raw-time/row-position 未决定 |
